...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$__nesc_unnamed4316 {
...
enum TossimPacketModelC$__nesc_unnamed4322 {
#line 93
...
#line 370
      ...
      switch (__nesc_ntoh_uint8(rcvpkt->_type.data)) {
          ...
          case GRAY: 
            ...
            sim_log_debug(141U, "receiveColor", "[ %s ] *** Mote-(%d) - GRAY received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
          ...
          case WHITE: 
            ...
            sim_log_debug(142U, "receiveColor", "[ %s ] *** Mote-(%d) - WHITE received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);

          break;

          default: 
            sim_log_error(143U, "Error", "[ %s ] -- Receive.receive(): No match for the packet from Mote-(%d) --> Mote-(%d) \n", sim_time_string(), sourceNodeid, TOS_NODE_ID);
        }

      WSNProjectC$printStep$postTask();
    }
  else {
      sim_log_error(144U, "Error", "[ %s ] *** Mote-(%d) - Foreign packet received from Mote-(%d). \n", sim_time_string(), TOS_NODE_ID, sourceNodeid);
    }
  return msg;
}
...
#line 115
# 69 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7d0507e0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7d0507e0, addr, msg, len);
#line 69
...
#line 309
  ...
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(194U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 319
      ...
      sim_log_debug_clear(195U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(196U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(197U, "CpmModelC", " no acknowledgment requested.\n");
        }
...
#line 315
{
  sim_log_debug(131U, "stopDone", "[ %s ] -- AMControl.stopDone(). \n", sim_time_string());
}
...
# 89 "C:/cygwin/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7d053da8, message_t * msg, error_t error){
#line 89
  switch (arg_0x7d053da8) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7d053da8, msg, error);
#line 89
      break;
#line 89
    }
...
#line 321
{
  ...
  sim_log_debug(132U, "Timer0fired", "[ %s ] -- onTimer0Fired: \n", sim_time_string());

  if (WSNProjectC$myColor[sim_node()] == WHITE) {
      sim_log_debug(133U, "Timer0fired", "[ %s ] -- WHITE. \n", sim_time_string());
...
# 72 "C:/cygwin/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7d219a20){
#line 72
  switch (arg_0x7d219a20) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7d219a20);
#line 72
      break;
#line 72
    }
...
#line 87
  ...
  sim_log_debug(122U, "printArray", "*** Mote-(%d) - %s: [ ", TOS_NODE_ID, arrName);
  for (i = 0; i < size; i++) {
      printf("%d; ", arr[i]);
    }
  printf("] \n \n");
...
#line 278
{
  ...
  uint8_t i;
  uint8_t size = WSNProjectC$sizeofArray(topology20[TOS_NODE_ID - 1]);

  for (i = 0; i < size; i++) {
      WSNProjectC$neighborNodes[sim_node()][i] = topology20[TOS_NODE_ID - 1][i];
    }
  ...
  sim_log_debug(130U, "booted", "[ %s ] -- Booted.\n", sim_time_string());
...
#line 139
    {
      sim_log_error(123U, "Error", "[ %s ] -- deleteElement(): Array does not contain %d value. \n", sim_time_string(), val);
    }
}
...
#line 164
          {
            sim_log_error(124U, "Error", "[ %s ] -- addElement(): Not possible to add element %d due to case 1.!!! \n", sim_time_string(), val);
          }
        }
    }
  else 
#line 167
    {
      sim_log_error(125U, "Error", "[ %s ] -- addElement(): Not possible to add element %d due to case 2.!!! \n", sim_time_string(), val);
    }
}
...
#line 336
{
  ...
  switch (__nesc_ntoh_uint8(releasedMsg->_type.data)) {
      case GRAY: 
        sim_log_debug(134U, "sendDone", "[ %s ] -- AMSend.sendDone(): GRAY message from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;

      case BLACK: 
        sim_log_debug(135U, "sendDone", "[ %s ] -- AMSend.sendDone(): BLACK message from from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;

      case WHITE: 
        sim_log_debug(136U, "sendDone", "[ %s ] -- AMSend.sendDone(): WHITE message from from Mote-(%d) --> Mote-(ALL) was sent. \n", sim_time_string(), TOS_NODE_ID);

      break;
      default: 
        sim_log_error(137U, "Error", "[ %s ] -- AMSend.sendDone(): No match for the packet from Mote-(%d) --> Mote-(%d) \n", sim_time_string(), TOS_NODE_ID);
    }
}
